...
I gave my first long technical talk in the tech division of [State Grid](http://en.wikipedia.org/wiki/State_Grid_Corporation_of_China). The topic was [D3.js](http://d3js.org/), the JavaScript visualization library from Stanford. You can read more about what happened in [my blog post](/blog/2013/02/speaking-is-fun/), or see the [slides](http://scottcheng.github.com/d3js-101/).
